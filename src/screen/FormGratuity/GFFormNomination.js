            ...
            <ol className="list-group" style={{ textAlign: "left" }}>
                ...
                <li>
                    <div>
                        <TextAreaInput
                            ...
                            defaultValue={
                                userInfoGF && userInfoGF.nomination_details
                            }
                        />
                    </div>
                    <div className="mt-3">
                        <h5 style={{ fontFamily: "Muller" }}>
                            I,Shri/Shiramti/Kumari
                        </h5>
                        <TextAreaInput
                            formState={props.formState}
                        ...
                        >
                            ...
                            hereby nominate the person(s) mentioned below to
                            receive the gratuity payable after my death as also
                            the gratuity standing to my credit in the event of
                            my death before that amount has become payable, or
                            having become payable has not been paid and direct
                            that the said amount of gratuity shall be paid in
                            proportion indicated against the name(s) of the
                            nominee(s).
                        </h5>
                    </div>
                </li>
                ...
                <li className="mt-3">
                    <h5 style={{ fontFamily: "Muller" }}>
                        ...
                        member(s) of my family within the meaning of clause (h)
                ...
                <li className="mt-3">
                    <h5 style={{ fontFamily: "Muller" }}>
                        I hereby declare that I have no family within the
                ...
                <li className="mt-3">
                    <div className="row">
                        <div className="col-6">
                            <h5 style={{ fontFamily: "Muller" }}>
                                I have excluded my husband from my family by a
                                notice dated the :{" "}
                            </h5>
                        </div>
                        <div className="col-6">
                        ...
                        <div className="col-12">
                            <h5 style={{ fontFamily: "Muller" }}>
                                ...
                                proviso to clause (h) of Section 2 of the said
                                Act.
                            </h5>
                        </div>
                        <hr />
                ...
                <li className="mt-3">
                    <h5 style={{ fontFamily: "Muller" }}>
                        Nomination made herein invalidates my previous
                        nomination.
                    </h5>
                </li>
                <hr />
